...
public class InitData{
    ...
    public InitData(float minimumValue, float maximumValue, int numberOfSteps,int startStepSequ1,int startStepSequ2,int stopAmount,int numberThresholdPoints,string resultsPath,string experimentName,string conditionName,int numberParticipant,bool stopCriterionReversals,bool strictLimits,string plotTitle){
