...
public class StaircaseProcedure : MonoBehaviour
{
    ...
    /// <param name="stepsUp"> (default: 1) (when using a weighted up/down method) how many steps to increase the stimulus when answer was wrong/not detected (integer, min. 1)</param>
    /// <param name="stepsDown"> (default: 1) (when using a weighted up/down method) how many steps to decrease the stimulus when answer was correct/detected (integer, min. 1)</param>
    /// <param name="stepsUpStart"> (default: 1) (when using a "quick start") how many steps to increase the stimulus when answer was wrong/not detected (integer, min. 1) before the first reversal has occurred </param>
    /// <param name="stepsDownStart"> (default: 1) (when using a "quick start") how many steps to decrease the stimulus when answer was wrong/not detected (integer, min. 1) before the first reversal has occurred </param>
